...
N_BLOCKS = 2
N_TRIALS_IN_BLOCK = 32 // N_BLOCKS

INSTR_START = """
In this task, you have to indicate whether the meaning of a word and the colour of its font match.
...
stims = stims = {w: {c: stimuli.TextLine(w, text_colour=c) for c in COLOURS} for w in COLOURS}
...
for block_id in range(1, N_BLOCKS + 1):
    for trial_id in range(1, N_TRIALS_IN_BLOCK + 1):
        ...
        run_trial(block_id, trial_id, trial_type, word, colour)
